...
import BookMetadata from "./Book.js";
import BookSummaryMetadata from "../BookSummary/BookSummary.js";
    ...
    async allBooks(root, args, context, ast) {
      ...
      if (queryPacket.metadataRequested.size) {
        ...
        if (queryPacket.metadataRequested.get("count")) {
          ...
          let countResults = await dbHelpers.runQuery(db, "books", [$match, { $group: { _id: null, count: { $sum: 1 } } }]);
