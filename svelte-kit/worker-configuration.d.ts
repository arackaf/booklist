/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b30909665a156bd6ab92727173d24428)
// Runtime types generated with workerd@1.20260611.1 2026-06-13 nodejs_compat
interface __BaseEnv_Env {
  HYPERDRIVE: Hyperdrive;
  ASSETS: Fetcher;
  PROCESS_COVER_LAMBDA: string;
  CHECK_SCAN_STATUS_LAMBDA: string;
  SCAN_BOOK_LAMBDA: string;
  SYNC_BOOK_RECOMMENDATIONS_LAMBDA: string;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      | "PROCESS_COVER_LAMBDA"
      | "CHECK_SCAN_STATUS_LAMBDA"
      | "SCAN_BOOK_LAMBDA"
      | "SYNC_BOOK_RECOMMENDATIONS_LAMBDA"
