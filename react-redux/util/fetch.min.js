!(function(t) {
  ...
  function h(t) {
    for (var e = new Uint8Array(t), r = Array(e.length), o = 0; o < e.length; o++) r[o] = String.fromCharCode(e[o]);
    return r.join("");
  }
  function f(t) {
      ...
      (this._initBody = function(t) {
        if (((this._bodyInit = t), t))
          if ("string" == typeof t) this._bodyText = t;
            ...
            if (!m.arrayBuffer || (!ArrayBuffer.prototype.isPrototypeOf(t) && !B(t))) throw Error("unsupported BodyInit type");
