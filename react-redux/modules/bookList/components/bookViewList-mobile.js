...
var AjaxButton = require('/react-redux/applicationRoot/rootComponents/ajaxButton');

var BookViewListMobile = (function (_React$Component) {
    _inherits(BookViewListMobile, _React$Component);
    ...
    _createClass(BookViewListMobile, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                null,
                this.props.list.map(function (book, i) {
                    return React.createElement(
                        'div',
                        { key: 'book' + i },
                        'Hey there - MOBILE'
