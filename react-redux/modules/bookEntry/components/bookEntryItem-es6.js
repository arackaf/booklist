    ...
    render(){
        return (
            <span>
                ...
                { this.props.fetchedTitle ? <span>Saved: { this.props.fetchedTitle } <AjaxButton css='btn-danger btn-xs' running={this.props.deleting} onClick={this.props.deleteBook} text='Delete' runningText='Deleting' /> <button className='btn btn-info btn-xs' onClick={() => this.expand()}>D</button></span> : null }
