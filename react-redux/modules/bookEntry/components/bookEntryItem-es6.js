    ...
    render(){
        return (
            <span>
                ...
                { this.props.fetchedTitle ? <span>Saved: { this.props.fetchedTitle } <AjaxButton running={this.props.deleting} onClick={this.props.deleteBook} text={'Delete'} runningText='Deleting' /> <button onClick={() => this.expand()}>D</button></span> : null }
