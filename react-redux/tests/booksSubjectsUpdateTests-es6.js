const { LOAD_BOOKS_RESULTS } = require('../../react-redux/modules/books/reducers/actionNames');
const { SET_BOOKS_SUBJECTS } = require('../../react-redux/modules/books/reducers/booksSubjectModification/actionNames');
const { booksResults } = require('../../react-redux/modules/books/reducers/actionCreators');

const assert = require('chai').assert;

const { booksReducer, booksSelector } = require('../../react-redux/modules/books/reducers/books/reducer');
